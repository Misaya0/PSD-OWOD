...
if __name__ == '__main__':
    coco_train_annotation_file = '/2T/gzj/datasets/COCO/annotations/instances_train2017.json'
    coco_val_annotation_file = '/2T/gzj/datasets/COCO/annotations/instances_val2017.json'
