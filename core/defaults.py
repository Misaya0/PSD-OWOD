...
def create_ddp_model(model, *, fp16_compression=False, **kwargs):
    ...
    print(kwargs["device_ids"])
    if not dist.is_initialized():  # 检查是否已初始化
...
""",
    ...
    parser.add_argument("--config-file", default="/2T/gzj/OrthogonalDet-main/configs/M-OWODB/t1.yaml", metavar="FILE", help="path to config file")
    parser.add_argument(
        "--resume",
        action="store_true",
