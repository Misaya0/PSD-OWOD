...
def get_parser():
    ...
    parser.add_argument(
        "--config-file",
        default="configs/M-OWODB/t2_ft.yaml",
        metavar="FILE",
    ...
    parser.add_argument(
        ...
        default=['MODEL.WEIGHTS', '/2T/gzj/OrthogonalDet-main/output/M-OWODB/model_0019999.pth'],
        # default=['MODEL.WEIGHTS', '/2T/gzj/OrthogonalDet-main/configs/M-OWODB/M-OWODB/model_0039999.pth'],
...
if __name__ == "__main__":
    ...
    if args.input:
        for path in tqdm.tqdm(args.input, disable=not args.output):
            ...
            path = osp.join('/2T/gzj/OrthogonalDet-main', path + '.jpg')
