...
imageset_dir = "/2T/gzj/OrthogonalDet-main/datasets/ImageSets/Main/M-OWODB/t1.txt"
...
sam_dir = "/2T/gzj/OrthogonalDet-main/datasets/SAM"
for image_id in fileids:
    image = cv2.imread('/2T/gzj/datasets/VOCdevkit/VOC2007/JPEGImages/' + image_id + '.jpg')
