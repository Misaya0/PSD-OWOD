...
model_type = "vit_h"
sam_checkpoint = "/2T/gzj/OrthogonalDet-main/segment-anything/sam_vit_h_4b8939.pth"
...
imageset_dir = "/2T/gzj/OrthogonalDet-main/datasets/ImageSets/Main/S-OWODB/t1.txt"
...
json_ids = [file.strip('.json') for file in os.listdir(sam_dir) if file.endswith('.json')]

for image_id in fileids:
    if image_id in json_ids:
        continue
